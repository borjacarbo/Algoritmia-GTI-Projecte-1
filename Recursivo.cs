...
namespace Torres_de_Hanoi
{
    public class Recursivo
    {
        public Recursivo(int n)
        {
            ...
            int movimientos = hanoi.recursivo(n, ref ini, ref fin, ref aux);
            ...
            Console.WriteLine(" ");
            Console.WriteLine(" ");
            Console.WriteLine("Utilizando recursividad sale que la solución esta");
            Console.WriteLine("realizada con " + movimientos.ToString() + " movimientos.");
